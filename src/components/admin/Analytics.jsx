  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="admin-analytics">
      ...
      <div className="analytics-grid">
        ...
        {/* Drop‑off Heatmap (Bar Chart) */}
        <div className="chart-card">
          <h3>Episode Drop‑off (earliest exit)</h3>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data.dropoff} layout="vertical">
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis type="number" />
        ...
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie data={data.genres} dataKey="count" nameKey="name" cx="50%" cy="50%" outerRadius={100} label>
